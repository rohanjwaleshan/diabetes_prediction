...
### The Better Model
Based on the results for the random forest model and svm model the random forest model performs better. The random forest classified more true negatives and true positives, and had a higher accuracy, precision, recall, and f1-score.
